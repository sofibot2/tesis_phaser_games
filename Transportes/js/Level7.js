var Level7 = new Phaser.Class({
    ...
    preload: function () {
        // AUDIO
        this.load.audio('audio_barco', ['sounds/audio_barco.mp3', 'sounds/audio_barco.ogg']);
    },

    create: function () {
        this.scene.start('Game_Level7');
    },

});

var Game_Level7 = new Phaser.Class({

    Extends: Phaser.Scene,

    initialize:

        function Game_Level7() {
            Phaser.Scene.call(this, { key: 'Game_Level7' });
        },
    ...
    create: function () {
        ...
        var audio_barco = this.sound.add('audio_barco');
        audio_barco.play();
...
var WinScreen7 = new Phaser.Class({
    ...
    initialize:
        ...
        function WinScreen7() {
            Phaser.Scene.call(this, { key: 'WinScreen7' });
        },
    ...
    create: function () {
        ...
        var barco = this.add.sprite(screenCenterX, screenCenterY * 0.5, 'barco').setInteractive();
        barco.setScale(0.3);
